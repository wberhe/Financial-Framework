...
public class JDialog_AddPAcc extends javax.swing.JDialog
{
	...
	public JDialog_AddPAcc(MainGUI myframe)
	{
		super(myframe);
		parentframe=myframe;
	...
	class SymMouse extends java.awt.event.MouseAdapter
	{
		public void mouseClicked(java.awt.event.MouseEvent event)
		{
			...
			if (object == JRadioButton_Gold)
				...
				JRadioButtonBro_mouseClicked(event);
		}
	}
	...
	void JRadioButtonBro_mouseClicked(java.awt.event.MouseEvent event)
	{
		//When Saving radio is clicked make this radio on 
		//and make Checking account radio off
		JRadioButton_Gold.setSelected(false);
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
       ...
       if (JRadioButton_Gold.isSelected())
           parentframe.accountType="G";
       else if(JRadioButton_Silver.isSelected())
           parentframe.accountType="S";
       else
    	   parentframe.accountType="B";
